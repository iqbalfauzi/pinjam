...
<script type="text/javascript">
 ...
 function datatable() {
  table = $('#tabel').DataTable({
    ...
    "order": [],
    "ajax":{
     url: "<?php echo base_url('mhs/C_report/datatable'); ?>",
     type: "POST",
...
function print_excell() {
  filterBea = $('#filterBea').val();
  window.open("<?=site_url()?>mhs/C_report/get_print_excell/"+filterBea);
}
function print_pdf() {
  filterBea = $('#filterBea').val();
  window.open("<?=site_url()?>mhs/C_report/get_print_pdf/"+filterBea);
}
