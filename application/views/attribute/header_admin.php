    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-gg-circle"></i> <span>Contest</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="<?php echo base_url('admin/C_contest')?>"><i class="fa fa-circle-o"></i> Setting Contest</a></li>
              <!-- <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li> -->
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
              <i class="fa fa-object-ungroup"></i> <span>AHP</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="<?php echo base_url('admin/C_pair')?>"><i class="fa fa-circle-o"></i> Pair Criteria</a></li>
              <!-- <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li> -->
            </ul>
          </li>
          <li>
            <a href="<?php echo base_url('admin/C_registrant')?>">
              <i class="fa fa-th"></i> <span>Input Athletes</span> <small class="label pull-right bg-green"><?php echo $count_contest;?></small>
            </a>
          </li>
          <li>
            <a href="<?php echo base_url('admin/C_selection')?>">
              <i class="fa fa-newspaper-o"></i> <span>Selection Process</span>
            </a>
          </li>
          <li>
